...
export default function TrabajadorForm({ trabajadorId, onClose }: TrabajadorFormProps) {
  ...
  return (
    <div className="fixed inset-0 bg-[#090e17] bg-[radial-gradient(circle_at_top_right,rgba(59,130,246,0.1),transparent_45%)] z-50 flex flex-col w-screen h-screen overflow-hidden animate-fadeIn">
      <div className="w-full h-full flex flex-col overflow-hidden">
        {/* Form Header */}
        <div className="w-full bg-surface-2 border-b border-border shadow-md">
          <div className="max-w-5xl mx-auto h-16 px-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs font-medium text-text-soft">
                Complete todos los datos personales, previsionales, operativos y accesos TI
              </p>
            </div>
            <button 
              onClick={onClose}
              className="p-2 rounded-xl hover:bg-bg text-text-muted hover:text-text transition-colors border border-transparent hover:border-border cursor-pointer"
            >
              <X size={18} />
            </button>
          </div>
        ...
        {/* Form Category Tabs */}
        <div className="w-full bg-surface border-b border-border overflow-x-auto custom-scrollbar">
          <div className="max-w-5xl mx-auto flex px-6 space-x-6">
            {[
          ...
          <div className="max-w-5xl mx-auto p-6 space-y-8">
            ...
            {activeTab === "personal" && (
              <div className="space-y-6">
                <div className="bg-surface/30 backdrop-blur-sm border border-border/80 p-6 rounded-2xl space-y-6 shadow-sm">
                  <h3 className="text-xs font-bold text-blue-400 uppercase tracking-widest border-b border-zinc-800 pb-3 flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className={`w-full bg-zinc-900/60 border text-sm text-white rounded-lg p-2.5 focus:outline-none focus:border-blue-500 transition-colors ${
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 rounded-xl bg-zinc-900/30 border border-zinc-800/80">
                    <div className="space-y-1.5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full bg-zinc-900/60 border text-sm text-white rounded-lg p-2.5 focus:outline-none focus:border-blue-500 disabled:opacity-40 transition-colors ${
              ...
              <div className="space-y-6">
                <div className="bg-surface/30 backdrop-blur-sm border border-border/80 p-6 rounded-2xl space-y-6 shadow-sm">
                  ...
                  {formData.sistema_salud === "Isapre" && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-xl bg-zinc-900/30 border border-zinc-800/80 animate-fadeIn">
                      <div className="space-y-1.5">
            ...
            {/* TAB 5: ACCESOS TI Y SAP */}
            {activeTab === "sap" && (
              <div className="space-y-6">
                {/* 1. Cuenta de Correo Codelco */}
                <div className="bg-surface/30 backdrop-blur-sm border border-border/80 p-6 rounded-2xl space-y-4 shadow-sm">
                  <h3 className="text-xs font-bold text-blue-400 uppercase tracking-widest border-b border-zinc-800 pb-3 flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-blue-400 shadow-[0_0_8px_rgba(96,165,250,0.8)]"></span>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div className="col-span-1 sm:col-span-2 md:col-span-1 flex items-center pt-6">
                ...
                <div className="bg-surface/30 backdrop-blur-sm border border-border/80 p-6 rounded-2xl space-y-4 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="col-span-1 sm:col-span-2 md:col-span-3 flex items-center pb-2">
                      <label className="flex items-center gap-2.5 text-xs text-white font-semibold cursor-pointer group">
                        <input
                          type="checkbox"
        ...
        {/* Form Footer */}
        <div className="w-full bg-surface-2 border-t border-border">
          <div className="max-w-5xl mx-auto h-20 px-6 flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <button
                type="button"
                onClick={onClose}
                className="px-4 py-2 border border-zinc-800 hover:border-zinc-700 text-zinc-300 hover:text-white text-sm font-semibold rounded-lg transition-colors cursor-pointer"
              >
                Cancelar
              </button>
              <button
                ...
                className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold rounded-lg flex items-center gap-1.5 hover:shadow-lg hover:shadow-blue-600/20 transition-all cursor-pointer"
              >
                <Save size={14} />
                Guardar Ficha
              </button>
